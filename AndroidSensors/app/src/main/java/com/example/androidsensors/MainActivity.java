...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private Sensor proximitySeneor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proximitySeneor = sensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY);
    ...
    protected void onResume() {
        ...
        sensorManager.registerListener(this, proximitySeneor, SensorManager.SENSOR_DELAY_NORMAL);
